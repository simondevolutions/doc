...
5. Envoyer le fichier à l&apos;équipe de soutien technique en suivant les instructions de la rubrique [Envoi d’un fichier de manière sécurisée à notre équipe](https://docs.devolutions.com/fr/kb/devolutions-customer-success/securely-send-file/). 
